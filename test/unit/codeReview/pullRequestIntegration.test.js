...
describe('PullRequestIntegration - JavaScript', () => {
  ...
  describe('detectProvider', () => {
    it('should detect GitHub provider if .git/config contains github.com URL', async () => {
      ...
      global.require = (module) => module === 'fs' ? mockFs : originalFs(module);
  ...
  describe('getOpenPullRequests', () => {
    it('should return GitHub pull requests when provider is GitHub', async () => {
      ...
      global.require = (module) => {
        if (module === 'axios') return mockAxios;
  ...
  describe('checkPullRequestQuality', () => {
    it('should check quality of a pull request', async () => {
      ...
      sandbox.stub(pullRequestIntegration, 'checkFileQuality')
        .onFirstCall().resolves({ issues: 2, suggestions: ['Fix issue 1', 'Fix issue 2'] })
        .onSecondCall().resolves({ issues: 1, suggestions: ['Fix issue 3'] });
