 ...
 * Source: src\tools\dependencyAnalyzer.js
 */
...
describe('DependencyAnalyzer', () => {
    ...
    describe('analyzeDependencies', () => {
        ...
        it('should throw error if package.json not found', async () => {
            ...
            // Execute and assert error is thrown
            try {
                await analyzer.analyzeDependencies(projectPath);
                assert.fail('Expected error was not thrown');
            } catch (error) {
                assert.ok(error.message.includes('Failed to analyze dependencies: File not found'));
            }
        });
    ...
    describe('analyzeFileImports', () => {
        ...
        it('should throw error if file not found', async () => {
            ...
            // Execute and assert error is thrown
            try {
                await analyzer.analyzeFileImports(filePath);
                assert.fail('Expected error was not thrown');
            } catch (error) {
                assert.ok(error.message.includes('Failed to analyze file imports: File not found'));
            }
        });
    ...
    describe('private methods', () => {
        describe('addImportToGraph', () => {
            it('should correctly identify node modules vs local imports', async () => {
                ...
                const addImportToGraph = analyzer.addImportToGraph.bind(analyzer);
        ...
        describe('buildFileImportGraph', () => {
            it('should correctly identify imports and build graph', async () => {
                ...
                // Need to access the private method
                const buildFileImportGraph = analyzer.buildFileImportGraph.bind(analyzer);
        ...
        describe('buildDependencyGraph', () => {
            it('should handle package.json with peer and optional dependencies', async () => {
                ...
                // Need to access the private method
                const buildDependencyGraph = analyzer.buildDependencyGraph.bind(analyzer);
