...
class VectorDatabasePanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(VectorDatabasePanel.viewType, 'Vector Database', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    constructor(panel, extensionUri) {
        ...
        this._panel.webview.onDidReceiveMessage(async (message) => {
            ...
            const searchService = (0, codeSearch_1.getCodeSearchService)();
            switch (message.command) {
                ...
                case 'indexWorkspace':
                    try {
                        const count = await searchService.indexWorkspace(message.includePattern, message.excludePattern);
