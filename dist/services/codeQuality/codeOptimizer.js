...
class CodeOptimizer {
    ...
    analyzeJavaScriptPerformance(text, document, issues) {
    ...
    analyzeJavaScriptMemory(text, document, issues) {
    ...
    analyzePythonPerformance(text, document, issues) {
    ...
    analyzePythonMemory(text, document, issues) {
    ...
    analyzeJavaPerformance(text, document, issues) {
    ...
    analyzeJavaMemory(text, document, issues) {
    ...
    findNestedLoops(document, issues) {
        const text = document.getText();
    ...
    findPotentiallyUnboundedRecursion(document, issues) {
        const text = document.getText();
        const fileExtension = path.extname(document.uri.fsPath).toLowerCase();
