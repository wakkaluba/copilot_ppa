                ...
                if (criticalCount > 0 || highCount > 0) {
                    ...
                    vscode.window.showErrorMessage(message, 'View Details').then(selection => {
                        if (selection === 'View Details') {
                            securityVulnerabilityPanel_1.SecurityVulnerabilityPanel.createOrShow(context.extensionUri, result.securityTest.vulnerabilities, 'Security Vulnerabilities');
                        }
                    });
                }
