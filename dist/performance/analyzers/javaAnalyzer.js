...
class JavaAnalyzer extends baseAnalyzer_1.BasePerformanceAnalyzer {
    ...
    analyzeMemoryPatterns(fileContent, lines, result) {
    ...
    analyzeConcurrencyPatterns(fileContent, lines, result) {
    ...
    analyzePerformancePatterns(fileContent, lines, result) {
    ...
    analyzeCollectionUsage(fileContent, lines, result) {
    ...
    analyzeStreamOperations(fileContent, lines, result) {
    ...
    analyzeExceptionHandling(fileContent, lines, result) {
    ...
    analyzeJavaSpecifics(fileContent, _lines, result) {
    ...
    findFirstOccurrence(lines, searchString, pattern) {
    ...
    analyzeParallelStreamUsage(fileContent, lines, result, parallelStreamCount) {
