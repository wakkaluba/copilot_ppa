...
class CSharpAnalyzer extends baseAnalyzer_1.BasePerformanceAnalyzer {
    ...
    analyzeLINQOperations(fileContent, lines, result) {
    ...
    analyzeStringOperations(fileContent, lines, result) {
    ...
    analyzeDisposableUsage(fileContent, lines, result) {
    ...
    analyzeAsyncAwait(fileContent, lines, result) {
    ...
    analyzeLoopAllocations(fileContent, lines, result) {
    ...
    calculateCSharpMetrics(content) {
