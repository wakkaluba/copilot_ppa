...
class PythonAnalyzer extends baseAnalyzer_1.BasePerformanceAnalyzer {
    ...
    analyzeComprehensions(fileContent, lines, result) {
    ...
    analyzeGeneratorUsage(fileContent, lines, result) {
    ...
    analyzeDataStructures(fileContent, lines, result) {
    ...
    analyzePythonSpecifics(fileContent, lines, result) {
