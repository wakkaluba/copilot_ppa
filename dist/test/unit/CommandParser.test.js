...
describe('CommandParser Tests', function () {
    ...
    it('parseAndExecute should call correct handler for valid command', function () {
    ...
    it('parseAndExecute should throw error for invalid command format', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    it('parseAndExecute should throw error for unknown command', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    it('registerCommand should add custom command handler', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var customHandler;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    it('createFile command should call workspaceManager.writeFile', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    it('modifyFile command should read and write file', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    it('deleteFile command should call workspaceManager.deleteFile', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
