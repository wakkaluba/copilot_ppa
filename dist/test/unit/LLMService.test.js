...
suite('LLMService Tests', function () {
    ...
    test('generateResponse should use the provider to generate text', function () {
    ...
    test('generateResponse should use custom options if provided', function () {
        return __awaiter(void 0, void 0, void 0, function () {
    ...
    test('generateResponse should return cached response if available', function () {
        return __awaiter(void 0, void 0, void 0, function () {
    ...
    test('generateResponse should handle provider errors', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var prompt, error;
            return __generator(this, function (_a) {
                switch (_a.label) {
