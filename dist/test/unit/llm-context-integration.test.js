...
describe('LLM and Context Integration', function () {
    ...
    it('should integrate context with LLM generation', function () {
    ...
    it('should handle prompt modifications based on history', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        contextManagerMock.buildPrompt.callsFake(function (convId, userPrompt) {
                            return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should handle token limits by truncating history', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        longHistory = Array.from({ length: 20 }, function (_, i) {
                            return ({
