...
suite('GitLabProvider Tests', function () {
    ...
    test('createRepository should create project with correct options', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var options;
    ...
    test('createRepository should handle public visibility', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    test('getRepositories should return list of projects', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var repos, options;
            return __generator(this, function (_a) {
                switch (_a.label) {
