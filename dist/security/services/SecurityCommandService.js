    ...
    async generateRecommendations() {
        await vscode.window.withProgress({
            ...
            try {
                ...
                await this.reportSvc.showFullReport({ issues: [], scannedFiles: 0, timestamp: new Date() }, { vulnerabilities: [], totalDependencies: 0, hasVulnerabilities: false, timestamp: new Date() }, result);
            }
            catch (error) {
