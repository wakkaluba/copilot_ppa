...
class ViteOptimizationService {
     ...
     */
    async generateSuggestions(content, build, plugins, optimizationOptions) {
        try {
            const suggestions = [];
    ...
    checkBuildOptimizations(build, suggestions) {
  ...
  build: {
    ...
    checkPluginOptimizations(plugins, suggestions) {
...
export default defineConfig({
  plugins: [
    ...
    checkDependencyOptimizations(options, suggestions) {
  ...
  build: {
    ...
    checkPerformanceOptimizations(content, suggestions) {
...
//# sourceMappingURL=ViteOptimizationService.js.map