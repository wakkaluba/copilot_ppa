...
class PerformanceAnalyzer {
    ...
    constructor(context, llmService) {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('vscode-local-llm-agent.analyzePerformance', this.analyzeCurrentFile.bind(this)), vscode.commands.registerCommand('vscode-local-llm-agent.analyzeWorkspacePerformance', this.analyzeWorkspace.bind(this)), this.diagnosticCollection);
    }
    /**
     ...
     */
    async performStaticAnalysis(content, fileType) {
        const issues = [];
     ...
     */
    async performLLMAnalysis(content, fileType) {
