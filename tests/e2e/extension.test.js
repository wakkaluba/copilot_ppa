...
describe('Extension E2E Tests', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    extension = vscode.extensions.getExtension('copilot-ppa');
                    if (!extension) {
    ...
    test('Commands are registered', function () { return __awaiter(void 0, void 0, void 0, function () {
        var allCommands;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    test('Views are registered', function () {
        ...
        var copilotPPAView = vscode.window.registerTreeDataProvider('copilotPPAConversations', {});
