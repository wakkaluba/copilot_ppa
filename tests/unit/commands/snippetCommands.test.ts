...
import { SnippetCommands } from '../../../src/commands/snippetCommands';
import { ConversationManager } from '../../../src/services/conversationManager';
import { SnippetManager } from '../../../src/services/snippetManager';
import { SnippetCreationService } from '../../../src/services/snippets/SnippetCreationService';
import { SnippetInsertionService } from '../../../src/services/snippets/SnippetInsertionService';
import { SnippetSelectionService } from '../../../src/services/snippets/SnippetSelectionService';
...
describe('SnippetCommands', () => {
  let snippetCommands: SnippetCommands;
  let mockContext: vscode.ExtensionContext;
  let mockCreationService: jest.Mocked<SnippetCreationService>;
  let mockSelectionService: jest.Mocked<SnippetSelectionService>;
  let mockInsertionService: jest.Mocked<SnippetInsertionService>;
  ...
  beforeEach(() => {
    ...
    mockCreationService = (snippetCommands as any).creationService;
    mockSelectionService = (snippetCommands as any).selectionService;
    mockInsertionService = (snippetCommands as any).insertionService;
  });
  ...
  test('should create snippet with conversation id and message indices', async () => {
    ...
    const createSnippetHandler = (vscode.commands.registerCommand as jest.Mock).mock.calls.find(
  ...
  test('should select and insert snippet', async () => {
    ...
    const insertSnippetHandler = (vscode.commands.registerCommand as jest.Mock).mock.calls.find(
  ...
  test('should open snippets panel when managing snippets', async () => {
    ...
    const manageSnippetsHandler = (vscode.commands.registerCommand as jest.Mock).mock.calls.find(
