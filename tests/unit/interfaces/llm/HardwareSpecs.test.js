...
describe('HardwareSpecs interface', function () {
    it('should handle minimal hardware specs', function () {
        var specs = {
            cpu: {
                cores: 4,
                model: 'Intel Core i5',
    ...
    it('should handle high-end hardware specs', function () {
        var specs = {
            cpu: {
                cores: 12,
                model: 'Intel Core i9',
    ...
    it('should handle specs with unavailable GPU', function () {
        var specs = {
            cpu: {
                cores: 8,
                model: 'Intel Core i7',
    ...
    it('should handle AMD GPU specs', function () {
        var specs = {
            cpu: {
                cores: 6,
                model: 'AMD Ryzen 5',
    ...
    it('should handle complete hardware specs', function () {
        var specs = {
            gpu: {
