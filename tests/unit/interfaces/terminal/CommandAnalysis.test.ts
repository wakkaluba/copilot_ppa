import { CommandAnalysis } from '../../../../src/terminal/types';

describe('CommandAnalysis Interface', () => {
  test('should create a command analysis with low risk', () => {
  ...
  test('should create a command analysis with medium risk', () => {
    const analysis: CommandAnalysis = {
      command: 'rm file.txt',
  ...
  test('should create a command analysis with high risk', () => {
    const analysis: CommandAnalysis = {
      command: 'rm -rf /',
  ...
  test('should create a command analysis without risk level', () => {
    const analysis: CommandAnalysis = {
