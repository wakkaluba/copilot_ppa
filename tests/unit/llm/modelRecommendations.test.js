/**
 * Tests for ModelRecommendationService in llm (JavaScript version)
 */
const { ModelRecommendationService } = require('../../../src/llm/modelRecommendations');
const axios = require('axios');

// Mock axios
jest.mock('axios');

describe('ModelRecommendationService (JavaScript)', () => {
    let modelRecommendationService;
