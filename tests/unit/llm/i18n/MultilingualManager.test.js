...
const { MultilingualManager } = require('../../../../src/llm/i18n/MultilingualManager');
const { LocalizationService } = require('../../../../src/i18n/localization');
const languageUtils = require('../../../../src/i18n/languageUtils');

describe('LLM MultilingualManager Tests', () => {
    let multilingualManager;
    let localizationServiceStub;
    let sandbox;
    let getLanguageNameStub;
    let mockContext;
    ...
    beforeEach(() => {
        ...
        multilingualManager.localizationService = localizationServiceStub;
    });
