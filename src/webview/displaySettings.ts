import { DisplaySettings } from '../services/displaySettingsService';
import * as vscode from 'vscode';

export function getDisplaySettingsPanel(currentSettings: DisplaySettings): string {
    return `
...
export function getDisplaySettingsStyles(): string {
    return `
...
export function getDisplaySettingsScript(): string {
    return `
