// filepath: d:\___coding\tools\copilot_ppa\src\webview\components\__tests__\messageRenderer.test.js
const { renderMessages } = require('../messageRenderer');
const { escapeHtml } = require('../../../utils/htmlEscaper');
...
describe('messageRenderer', () => {
    ...
    describe('renderMessages', () => {
        ...
        it('should return a no messages div when messages array is null or undefined', () => {
            // Act
            const result = renderMessages(undefined);
    ...
    describe('formatMessageContent', () => {
        ...
        it('should handle non-string content by converting to string', () => {
            ...
            const message = {
                role: 'assistant',
                content: 42,  // Number instead of string
                timestamp: new Date(2023, 0, 1, 12, 0, 0).getTime()
            };
            ...
            // Assert
            expect(result).toContain('<div class="message-content"><p>42</p></div>');
        });

        it('should handle object content by converting to string representation', () => {
            // Arrange
            const obj = { key: 'value' };
            const message = {
                role: 'assistant',
            ...
            // Assert
            expect(result).toContain('<div class="message-content"><p>[object Object]</p></div>');
        });
    });
});
