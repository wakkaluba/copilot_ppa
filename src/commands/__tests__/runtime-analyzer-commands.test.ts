// filepath: d:\___coding\tools\copilot_ppa\src\commands\__tests__\runtime-analyzer-commands.test.ts
import { afterEach, beforeEach, describe, expect, it } from '@jest/globals';
import * as sinon from 'sinon';
import * as vscode from 'vscode';
import { runtimeAnalyzer } from '../../runtime-analyzer';
import { registerRuntimeAnalyzerCommands } from '../runtime-analyzer-commands';
...
describe('Runtime Analyzer Commands', () => {
    ...
    let mockInputBox: sinon.SinonStub;
    let mockInfoMessage: sinon.SinonStub;
    let mockErrorMessage: sinon.SinonStub;
    let mockShowSaveDialog: sinon.SinonStub;
    let mockRuntimeAnalyzer: any;
