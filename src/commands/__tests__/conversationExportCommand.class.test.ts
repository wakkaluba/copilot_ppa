// filepath: d:\___coding\tools\copilot_ppa\src\commands\__tests__\conversationExportCommand.class.test.ts
...
import { ConversationExportCommand } from '../conversationExportCommand';

describe('ConversationExportCommand Class', () => {
    let mockContext: vscode.ExtensionContext;
    let mockConversationManager: any;
    let mockExportService: any;
    let mockFileDialogService: any;
    let mockSelectionService: any;
    let commandsMock: any;
    let mockWindow: any;
    let exportCommand: ConversationExportCommand;
