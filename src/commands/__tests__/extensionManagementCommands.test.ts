// filepath: d:\___coding\tools\copilot_ppa\src\commands\__tests__\extensionManagementCommands.test.ts
import { afterEach, beforeEach, describe, expect, it } from '@jest/globals';
import * as sinon from 'sinon';
import * as vscode from 'vscode';
import { ExtensionManagementCommands } from '../extensionManagementCommands';
...
describe('Extension Management Commands', () => {
    ...
    let mockInstallManager: any;

    // The class under test
    let extensionManagementCommands: ExtensionManagementCommands;
