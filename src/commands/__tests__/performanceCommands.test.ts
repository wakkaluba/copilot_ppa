// filepath: d:\___coding\tools\copilot_ppa\src\commands\__tests__\performanceCommands.test.ts
import { afterEach, beforeEach, describe, expect, it } from '@jest/globals';
import * as sinon from 'sinon';
import * as vscode from 'vscode';
import { PerformanceManager } from '../../performance/performanceManager';
import { Logger } from '../../utils/logger';
import { registerPerformanceCommands } from '../performanceCommands';
...
describe('Performance Commands', () => {
    ...
    let mockWarningMessage: sinon.SinonStub;

    // Mock PerformanceManager
    let mockPerfManager: any;
    let mockCachingService: any;
    let mockBottleneckDetector: any;
