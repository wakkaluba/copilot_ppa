// filepath: d:\___coding\tools\copilot_ppa\src\commands\__tests__\confirmationCommands.test.ts
...
import { registerConfirmationCommands } from '../confirmationCommands';
