// filepath: d:\___coding\tools\copilot_ppa\src\commands\__tests__\conversationExportCommand.js.test.js
const vscode = require('vscode');
const sinon = require('sinon');
const fs = require('fs');
const path = require('path');
const { registerConversationExportCommand } = require('../conversationExportCommand');
