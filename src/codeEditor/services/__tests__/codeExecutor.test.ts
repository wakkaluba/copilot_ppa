...
describe('CodeExecutorService', () => {
    ...
    describe('executeSelectedCode', () => {
        ...
        it('should use existing terminal if available', async () => {
            ...
            (vscode.window as any).activeTerminal = existingTerminal;
        ...
        it('should handle file system errors', async () => {
            ...
            (vscode.workspace.fs.writeFile as jest.Mock).mockRejectedValue(new Error('File system error'));
    ...
    describe('temporary file creation', () => {
        ...
        it('should handle different file extensions for different languages', async () => {
            ...
            (vscode.window as any).activeTextEditor = mockPythonEditor;
            ...
            (vscode.window as any).activeTextEditor = mockShellEditor;
