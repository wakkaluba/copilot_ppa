...
export class CodeEditorManager {
     ...
     */
    private getCodeOverviewHtml(symbols: vscode.DocumentSymbol[], language: string): string {
        function symbolToHtml(symbol: vscode.DocumentSymbol, indent: number = 0): string {
