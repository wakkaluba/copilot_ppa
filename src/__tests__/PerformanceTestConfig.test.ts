// filepath: d:\___coding\tools\copilot_ppa\src\__tests__\PerformanceTestConfig.test.ts
import { PerformanceTestConfig, PerformanceFramework } from '../services/testRunner/performanceTestConfig';

describe('PerformanceTestConfig Interface', () => {
  // Test for basic configurations
  describe('Basic Configuration', () => {
    it('should create a valid performance test config with required fields', () => {
  ...
  describe('Performance Framework Types', () => {
    it('should accept all supported performance frameworks', () => {
      // Define all supported frameworks
      const frameworks: PerformanceFramework[] = [
        'lighthouse', 
        'k6', 
        'autocannon', 
        'benchmark.js', 
  ...
  describe('Duration and Iterations', () => {
    it('should support iterations configuration', () => {
      const config: PerformanceTestConfig = {
    ...
    it('should support both iterations and duration if needed', () => {
      const config: PerformanceTestConfig = {
        framework: 'jmeter',
  ...
  describe('Framework-Specific Configurations', () => {
    it('should work with Lighthouse configuration', () => {
      const config: PerformanceTestConfig = {
        framework: 'lighthouse',
    ...
    it('should work with k6 configuration', () => {
      const config: PerformanceTestConfig = {
        framework: 'k6',
        command: 'k6 run --duration 30s performance/load-test.js',
        duration: 30,
    ...
    it('should work with autocannon configuration', () => {
      const config: PerformanceTestConfig = {
        framework: 'autocannon',
    ...
    it('should work with benchmark.js configuration', () => {
      const config: PerformanceTestConfig = {
