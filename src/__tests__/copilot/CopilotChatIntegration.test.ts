...
describe('CopilotChatIntegration', () => {
  ...
  beforeEach(() => {
    ...
    mockInitService = jest.mocked(require('../../copilot/services/CopilotChatInitializationService'), true);
    mockParticipantService = jest.mocked(require('../../copilot/services/CopilotChatParticipantService'), true);
    mockMessageHandlerService = jest.mocked(require('../../copilot/services/CopilotChatMessageHandlerService'), true);
    mockCommandHandlerService = jest.mocked(require('../../copilot/services/CopilotChatCommandHandlerService'), true);
