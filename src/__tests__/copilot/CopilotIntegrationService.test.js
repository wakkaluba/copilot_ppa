...
describe('CopilotIntegrationService', () => {
    ...
    describe('constructor and initialization', () => {
        ...
        it('should activate the extension if it is not active', async () => {
            ...
            vscode.extensions.getExtension.mockReturnValueOnce(inactiveExtension);
        ...
        it('should handle initialization errors gracefully', async () => {
            ...
            vscode.extensions.getExtension.mockReturnValueOnce(errorExtension);
    ...
    describe('isAvailable', () => {
        ...
        it('should return false when extension is not active', () => {
            ...
            copilotService.copilotExtension = { isActive: false };
            expect(copilotService.isAvailable()).toBe(false);
        });

        it('should return false when not initialized', () => {
            // Access private property for testing
            copilotService.isInitialized = false;
            expect(copilotService.isAvailable()).toBe(false);
        });
    });
    ...
    describe('sendToCopilotChat', () => {
        ...
        it('should handle errors in command execution', async () => {
            // Mock command error
            vscode.commands.executeCommand.mockRejectedValueOnce(new Error('Command error'));
    ...
    describe('registerChatResponseCallback', () => {
        it('should register a callback for chat responses', () => {
            ...
            vscode.workspace.onDidChangeConfiguration.mockReturnValueOnce(mockDisposable);
        ...
        it('should call the callback when a response is received', () => {
            // Mock onDidChangeConfiguration
            let configCallback;
            vscode.workspace.onDidChangeConfiguration.mockImplementationOnce((callback) => {
