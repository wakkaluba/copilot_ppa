import { LLMProvider, LLMProviderType } from '../llmProviders/types';
import { LLMModel } from '../llmProviders/llmModel';
...
describe('LLMModel Interface', () => {
  ...
  describe('Required Properties', () => {
    ...
    it('should error when missing required properties', () => {
      ...
      const missingProvider: LLMModel = {
        id: 'missing-provider',
      ...
      const missingDescription: LLMModel = {
    ...
    it('should error when provider has invalid value', () => {
      ...
      const invalidProvider: LLMModel = {
        id: 'invalid-provider',
  ...
  describe('Provider Types', () => {
    it('should accept all valid provider types', () => {
      ...
      const huggingfaceModel: LLMModel = {
...
describe('LLMModel', () => {
  ...
  describe('validation', () => {
    ...
    it('should accept valid provider types', () => {
      const validProviders: LLMProvider[] = ['ollama', 'lmstudio', 'huggingface'];
  ...
  describe('Model Validation', () => {
    it('should validate provider type', () => {
      expect(() => {
        new LLMModel({
          name: 'test-model',
          provider: 'invalid-provider' as LLMProviderType, // Type assertion for test
          modelId: 'test-id',
          contextWindow: 4096,
          pricing: {
            input: 0.0001,
