...
var ContextMenuManager = /** @class */ (function () {
    function ContextMenuManager(context) {
    ...
    ContextMenuManager.prototype.explainCodeHandler = function (uri) {
    ...
    ContextMenuManager.prototype.improveCodeHandler = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var editor, selection, text;
            return __generator(this, function (_a) {
                editor = vscode.window.activeTextEditor;
    ...
    ContextMenuManager.prototype.generateTestsHandler = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var editor, selection, text;
            return __generator(this, function (_a) {
                editor = vscode.window.activeTextEditor;
