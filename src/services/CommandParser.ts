...
type CommandArgs = Record<string, string>;
...
export class CommandParser implements IDisposable {
  ...
  public static getInstance(): CommandParser {
    if (!CommandParser.instance) {
      ...
      if (!workspaceManager || !logger) {
        throw new Error(
          'WorkspaceManager and Logger required for initial CommandParser initialization',
        );
      }
  ...
  public async parseAndExecute(command: string): Promise<void> {
    ...
    await handler(parsedCommand.args);
  }

  public parseCommand(command: string): { name: string; args: CommandArgs } | null {
    try {
  ...
  public parseArgs(argsString: string): CommandArgs {
  ...
  public async createFile(args: CommandArgs): Promise<void> {
  ...
  public async modifyFile(args: CommandArgs): Promise<void> {
  ...
  public async deleteFile(args: CommandArgs): Promise<void> {
