...
var TrustManager = /** @class */ (function () {
    function TrustManager() {
        this.trustedWorkspaces = new Set();
        this.initializeTrustState();
    }
    TrustManager.getInstance = function () {
        if (!this.instance) {
            this.instance = new TrustManager();
        }
        return this.instance;
    };
    TrustManager.prototype.initializeTrustState = function () {
        var _this = this;
        ...
        vscode.workspace.onDidGrantWorkspaceTrust(function () {
            _this.updateTrustState(true);
        });
    };
    TrustManager.prototype.updateTrustState = function (trusted) {
        if (vscode.workspace.workspaceFolders) {
            for (var _i = 0, _a = vscode.workspace.workspaceFolders; _i < _a.length; _i++) {
                var folder = _a[_i];
                if (trusted) {
    ...
    TrustManager.prototype.isPathTrusted = function (path) {
        return this.trustedWorkspaces.has(path) || vscode.workspace.isTrusted;
    };
    // Added method that's used in the tests
    TrustManager.prototype.isTrusted = function () {
        return vscode.workspace.isTrusted;
    };
    TrustManager.prototype.requireTrust = function (path) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, vscode.window.showWarningMessage('This operation requires workspace trust. Do you want to trust this workspace?', { modal: true }, 'Trust Workspace', 'Cancel')];
                    case 1:
                        result = _a.sent();
                        if (!(result === 'Trust Workspace')) return [3 /*break*/, 3];
                        ...
                        return [4 /*yield*/, vscode.commands.executeCommand('workbench.trust.manage')];
                    case 2:
                        // The requestWorkspaceTrust() API is not available directly in all VS Code versions
                        // Use the command instead which is more broadly supported
                        _a.sent();
                        return [2 /*return*/, vscode.workspace.isTrusted];
