...
export class SecurityTestingService {
     ...
     */
    private async detectSecurityTool(workspacePath: string): Promise<SecurityTool | undefined> {
     ...
     */
    private buildSecurityCommand(tool: SecurityTool, options: SecurityTestOptions): string {
        switch (tool) {
            case 'snyk':
     ...
     */
    private async parseSecurityResults(result: TestResult, tool: SecurityTool): Promise<SecurityVulnerability[]> {
     ...
     */
    private parseOwaspDependencyCheckResults(output: string): SecurityVulnerability[] {
        const vulnerabilities: SecurityVulnerability[] = [];
     ...
     * Parse Trivy results
     */
    private parseTrivyResults(output: string): SecurityVulnerability[] {
        const vulnerabilities: SecurityVulnerability[] = [];
     ...
     */
    private parseSonarQubeResults(output: string): SecurityVulnerability[] {
     ...
     */
    private parseGenericResults(output: string): SecurityVulnerability[] {
        const vulnerabilities: SecurityVulnerability[] = [];
     ...
     */
    private mapNpmSeverity(severity: string): 'info' | 'low' | 'medium' | 'high' | 'critical' {
     ...
     */
    private mapSnykSeverity(severity: string): 'info' | 'low' | 'medium' | 'high' | 'critical' {
        switch (severity.toLowerCase()) {
            case 'low':
                return 'low';
            case 'medium':
     ...
     */
    private mapTrivySeverity(severity: string): 'info' | 'low' | 'medium' | 'high' | 'critical' {
        switch (severity.toLowerCase()) {
            case 'low':
                return 'low';
            case 'medium':
     ...
     */
    private mapCvssScore(score?: number): 'info' | 'low' | 'medium' | 'high' | 'critical' {
     ...
     */
    private mapGenericSeverity(severity?: string): 'info' | 'low' | 'medium' | 'high' | 'critical' {
     ...
     */
    private generateSummary(vulnerabilities: SecurityVulnerability[]): Record<string, number> {
