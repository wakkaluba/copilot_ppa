...
var RetryService_1 = require("./services/RetryService");
var ModelCapabilityService_1 = require("./services/ModelCapabilityService");
var ConnectionErrorService_1 = require("./services/ConnectionErrorService");
var retryService = new RetryService_1.RetryService();
var modelCapabilityService = new ModelCapabilityService_1.ModelCapabilityService();
var errorService = new ConnectionErrorService_1.ConnectionErrorService();
...
function testConnection(url, timeout) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, retryService.testConnection(url, timeout)];
        });
    });
}
