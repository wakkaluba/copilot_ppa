...
var LLMProviderMetricsTracker = /** @class */ (function (_super) {
    ...
    function LLMProviderMetricsTracker() {
        ...
        _this.lastResponseTimes = new Map();
        _this.maxResponseTimeHistory = 100;
        return _this;
    }
    /**
     ...
     */
    LLMProviderMetricsTracker.prototype.recordSuccess = function (providerId, responseTimeMs, tokenCount) {
     ...
     */
    LLMProviderMetricsTracker.prototype.recordError = function (providerId, error, responseTimeMs) {
        var metrics = this.getMetrics(providerId);
        if (!metrics) {
            return;
        }
     ...
     */
    LLMProviderMetricsTracker.prototype.updateResponseTime = function (providerId, responseTimeMs) {
        var times = this.lastResponseTimes.get(providerId);
        if (!times) {
            return;
        }
        ...
        if (metrics) {
            metrics.averageResponseTime = times.reduce(function (a, b) { return a + b; }, 0) / times.length;
        }
    };
    /**
     * Emit metrics update event
     */
    LLMProviderMetricsTracker.prototype.emitMetricsUpdate = function (providerId) {
        var metrics = this.metrics.get(providerId);
        if (metrics) {
