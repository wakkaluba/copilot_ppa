...
function calculateRetryDelay(attempt, options) {
    var delay = Math.min(options.baseRetryDelay * Math.pow(2, attempt), options.maxRetryDelay);
 ...
 */
function testConnection(endpoint, timeout) {
...
function createTimeout(ms) {
    return new Promise(function (_, reject) {
        setTimeout(function () {
            reject(new LLMConnectionError(interfaces_1.ConnectionErrorCode.TIMEOUT, "Operation timed out after ".concat(ms, "ms")));
        }, ms);
    });
}
/**
...
function withTimeout(promise_1, timeoutMs_1) {
    return __awaiter(this, arguments, void 0, function (promise, timeoutMs, operation) {
        var result;
