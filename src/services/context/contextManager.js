...
var ContextManager = /** @class */ (function () {
    ...
    ContextManager.prototype.appendMessage = function (message) {
        this.messages.push(message);
        this.trimContextIfNeeded();
    };
    ContextManager.prototype.listMessages = function () {
        return __spreadArray([], this.messages, true);
    };
    ContextManager.prototype.getContextString = function () {
    ...
    ContextManager.prototype.trimContextIfNeeded = function () {
        var totalLength = this.getContextString().length;
