...
import { Bottleneck, BottleneckDetector } from '../bottleneckDetector';
...
describe('BottleneckDetector', () => {
  ...
  describe('detectBottlenecks', () => {
    test('skips unsupported file extensions', async () => {
      ...
      const result = await detector.detectBottlenecks(mockFile as vscode.Uri);
    ...
    test('detects all types of bottlenecks and combines results', async () => {
      ...
      const structuralBottlenecks: Bottleneck[] = [
        {
          file: '',
          startLine: 5,
          endLine: 10,
      ...
      const algorithmicBottlenecks: Bottleneck[] = [
        {
          file: '',
          startLine: 15,
          endLine: 20,
      ...
      const resourceBottlenecks: Bottleneck[] = [
        {
          file: '',
          startLine: 25,
          endLine: 30,
    ...
    test('handles cancellation during analysis', async () => {
      ...
      const mockFile = { fsPath: '/test/file.js' };
      await detector.detectBottlenecks(mockFile as vscode.Uri);
  ...
  describe('analyzeWorkspaceBottlenecks', () => {
    test('generates report from all workspace files', async () => {
      ...
      const mockBottlenecks1: Bottleneck[] = [
        {
          file: '/test/file1.js',
          startLine: 10,
          endLine: 15,
      ...
      const mockBottlenecks2: Bottleneck[] = [
        {
          file: '/test/file2.ts',
          startLine: 20,
          endLine: 25,
      ...
      (detector.detectBottlenecks as jest.Mock) = jest.fn()
  ...
  describe('Output and Reporting', () => {
    ...
    describe('generateBottleneckReport', () => {
      test('generates report with impact summary and file findings', () => {
        ...
        const reportContent = (fs.writeFileSync as jest.Mock).mock.calls[0][1];
