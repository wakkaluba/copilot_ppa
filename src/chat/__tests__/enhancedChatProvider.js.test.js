...
const { EnhancedChatProvider } = require('../enhancedChatProvider');
...
describe('EnhancedChatProvider JavaScript Implementation', () => {
    let provider;
    let mockContext;
    ...
    describe('setWebview', () => {
        it('should set webview and register message handler', () => {
            provider.setWebview(mockWebviewView);
    ...
    describe('Message handling', () => {
        ...
        it('should handle sendMessage command', async () => {
            ...
            await mockWebviewView.messageCallback(message);
