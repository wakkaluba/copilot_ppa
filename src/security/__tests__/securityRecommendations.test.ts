...
class MockRecommendationGenerator {
    constructor(private codeScanner: CodeSecurityScanner) {}
        ...
        return {
            issues: [
                ...
                },
                {
                    ...
                    severity: 'medium',
                    cwe: 'CWE-79',
                    location: { file: 'test.ts', line: 25, column: 12 },
...
class MockHtmlRenderer {
    static showRecommendations(context: vscode.ExtensionContext, result: any) {
        // This is a static method that doesn't return anything
    }
}

describe('SecurityRecommendations.ts', () => {
    let sandbox: sinon.SinonSandbox;
    let mockContext: vscode.ExtensionContext;
    let mockCodeScanner: sinon.SinonStubbedInstance<CodeSecurityScanner>;
    let securityRecommendations: SecurityRecommendations;
    let generatorStub: sinon.SinonStub;
    let rendererStub: sinon.SinonStub;
    ...
    beforeEach(() => {
        ...
        securityRecommendations = new SecurityRecommendations(mockContext, mockCodeScanner as unknown as CodeSecurityScanner);
    });
