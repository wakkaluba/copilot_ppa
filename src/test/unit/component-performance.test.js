...
describe('Component Performance', function () {
    ...
    beforeEach(function () {
        ...
        llmProviderManagerMock.generateCompletion.callsFake(function (prompt) { return __awaiter(void 0, void 0, void 0, function () {
            var delay;
    ...
    it('should track LLM response time', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should track token processing speed', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should track conversation metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 6:
                    ...
                    historyMock.getConversation.returns({
                        id: conversationId,
                        title: 'Performance Test',
                        messages: Array.from({ length: 5 }, function (_, i) { return ({
                            role: i % 2 === 0 ? 'user' : 'assistant',
                            content: "Message ".concat(i),
    ...
    it('should identify performance bottlenecks', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fastResult, slowResult, bottlenecks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // Setup a scenario with a slow response
                    llmProviderManagerMock.generateCompletion.onFirstCall().callsFake(function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                    ...
                    llmProviderManagerMock.generateCompletion.onSecondCall().callsFake(function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
