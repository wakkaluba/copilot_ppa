...
suite('ConversationMetadata Tests', function () {
    ...
    test('should persist metadata changes', function () { return __awaiter(void 0, void 0, void 0, function () {
        var metadata, loaded;
    ...
    test('should handle metadata cleanup', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test('should calculate metadata storage usage', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sampleMetadata, usage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sampleMetadata = Array(10).fill(null).map(function (_, i) { return ({
                        id: "convo-".concat(i),
