...
suite('BitbucketProvider Tests', function () {
    ...
    test('isConfigured should return true when credentials are configured', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
    ...
    test('isConfigured should return false when credentials are not configured', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
    ...
    test('getRepositories should handle missing repository data', function () { return __awaiter(void 0, void 0, void 0, function () {
        var repos;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
