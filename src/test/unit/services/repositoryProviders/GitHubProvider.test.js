...
var GitHubProvider_1 = require("../../../../services/repositoryProviders/GitHubProvider");
suite('GitHubProvider Tests', function () {
    var provider;
    var sandbox;
    ...
    setup(function () {
        ...
        var mockRepos = { createForAuthenticatedUser: createRepoStub, listForAuthenticatedUser: listReposStub };
        var mockOctokit = function () { this.repos = mockRepos; };
    ...
    test('createRepository should create repository with correct options', function () { return __awaiter(void 0, void 0, void 0, function () {
        var options;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Create new instance with undefined token
                    provider = new GitHubProvider_1.GitHubProvider();
                    return [4 /*yield*/, assert.rejects(function () { return provider.createRepository({ name: 'test-repo' }); }, /GitHub provider not configured/)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('getRepositories should return list of repositories', function () { return __awaiter(void 0, void 0, void 0, function () {
        var repos;
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Create new instance with undefined token
                    provider = new GitHubProvider_1.GitHubProvider();
                    return [4 /*yield*/, assert.rejects(function () { return provider.getRepositories(); }, /GitHub provider not configured/)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
