...
var PerformanceSessionService_1 = require("./services/PerformanceSessionService");
var MetricsCaptureService_1 = require("./services/MetricsCaptureService");
...
var CachingService_1 = require("./services/CachingService");
/**
...
var PerformanceProfiler = /** @class */ (function () {
    function PerformanceProfiler(context) {
    ...
    PerformanceProfiler.getInstance = function (context) {
        if (!PerformanceProfiler.instance) {
            PerformanceProfiler.instance = new PerformanceProfiler(context);
        }
        return PerformanceProfiler.instance;
    };
    PerformanceProfiler.prototype.setEnabled = function (enabled) {
        this.sessionService.enableProfiling(enabled);
    };
    PerformanceProfiler.prototype.startOperation = function (id) {
        this.sessionService.startSession(id);
    };
    PerformanceProfiler.prototype.endOperation = function (id, note) {
        var metrics = this.captureService.capture(id);
        this.sessionService.recordMetrics(id, metrics, note);
        this.bottleneckService.analyze(id, metrics);
    };
    PerformanceProfiler.prototype.getStats = function (id) {
        return this.sessionService.getStats(id);
    };
    PerformanceProfiler.prototype.getTrend = function (id) {
        return this.sessionService.getTrend(id);
    };
    PerformanceProfiler.prototype.getResourceStats = function (id) {
    ...
    PerformanceProfiler.prototype.clearStoredMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.persistenceService.clear()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PerformanceProfiler.prototype.dispose = function () {
