...
var CopilotIntegrationWebviewService_1 = require("./services/CopilotIntegrationWebviewService");
/**
 * WebView implementation for Copilot integration UI
 */
var CopilotIntegrationWebview = /** @class */ (function () {
    /**
     * Creates a new instance of the CopilotIntegrationWebview
     * @param context The extension context
     * @param copilotService The Copilot integration service
     */
    function CopilotIntegrationWebview(context, copilotService) {
     ...
     */
    CopilotIntegrationWebview.prototype.show = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.show()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    CopilotIntegrationWebview.prototype.dispose = function () {
        this.service.dispose();
    };
    CopilotIntegrationWebview.viewType = 'copilotIntegration.webview';
    return CopilotIntegrationWebview;
}());
