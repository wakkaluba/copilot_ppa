...
var ModelManager = /** @class */ (function () {
    ...
    ModelManager.prototype.initializeProviders = function () {
    ...
    ModelManager.prototype.addModel = function (config) {
    ...
    ModelManager.prototype.switchModel = function (modelName) {
        return __awaiter(this, void 0, void 0, function () {
            var config, provider;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = this.models.get(modelName);
                        if (!config) {
                            throw new Error("Model ".concat(modelName, " not found"));
                        }
                        provider = this.providers.get(config.provider);
                        if (!provider) {
                            throw new Error("Provider ".concat(config.provider, " not found"));
                        }
    ...
    ModelManager.prototype.getAvailableModels = function () {
