...
export class TerminalModule implements vscode.Disposable {
    ...
    private configureContainer(): void {
        ...
        this.container.bind<TerminalConfigurationService>(TerminalConfigurationService).toSelf().inSingletonScope();
        this.container.bind<TerminalCommandRegistrar>(TerminalCommandRegistrar).toSelf().inSingletonScope();
    }
    ...
    public setLLMManager(llmManager: any): void {
        try {
            ...
            this.container.bind<CommandGenerationWebview>('CommandGenerationWebview').toDynamicValue(() => {
