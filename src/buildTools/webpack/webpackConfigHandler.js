 ...
 */
var WebpackConfigHandler = /** @class */ (function () {
    function WebpackConfigHandler() {
     ...
     */
    WebpackConfigHandler.prototype.isConfigPresent = function () {
     ...
     */
    WebpackConfigHandler.prototype.openConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, vscode.window.showInformationMessage('No Webpack configuration files found. Create a new one?', 'Yes', 'No')];
                    case 1:
                        createNew = _c.sent();
     ...
     */
    WebpackConfigHandler.prototype.createNewConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    WebpackConfigHandler.prototype.getWebpackConfigTemplate = function () {
        return "const path = require('path');\n\nmodule.exports = {\n  entry: './src/index.js',\n  output: {\n    filename: 'bundle.js',\n    path: path.resolve(__dirname, 'dist'),\n  },\n  module: {\n    rules: [\n      {\n        test: /\\.js$/,\n        exclude: /node_modules/,\n        use: {\n          loader: 'babel-loader',\n        },\n      },\n      {\n        test: /\\.css$/,\n        use: ['style-loader', 'css-loader'],\n      },\n    ],\n  },\n  resolve: {\n    extensions: ['.js', '.json'],\n  },\n  devServer: {\n    contentBase: path.join(__dirname, 'dist'),\n    compress: true,\n    port: 9000,\n  },\n};\n";
    };
    /**
     * Provides suggestions for optimizing Webpack configuration
     */
    WebpackConfigHandler.prototype.suggestOptimizations = function (configPath) {
        return __awaiter(this, void 0, void 0, function () {
