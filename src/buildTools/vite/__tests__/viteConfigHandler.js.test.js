...
const { ViteOptimizationType } = require('../types');
...
describe('ViteConfigHandler JavaScript Implementation', () => {
    let handler;
    ...
    describe('isConfigPresent', () => {
        it('should return true when vite.config.js exists', async () => {
            ...
            vscode.workspace.findFiles.mockResolvedValue([{ fsPath: '/workspace/vite.config.js' }]);
        ...
        it('should handle different config file names', async () => {
            fs.existsSync.mockReturnValue(true);
            vscode.workspace.findFiles.mockResolvedValue([{ fsPath: '/workspace/vite.config.ts' }]);
    ...
    describe('openConfig', () => {
        it('should open existing config file', async () => {
            ...
            vscode.workspace.openTextDocument.mockResolvedValue(mockTextDocument);
