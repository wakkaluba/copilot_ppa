...
describe('ConfigValidationError', () => {
    it('should create error with message and code', () => {
        const error = new ConfigValidationError('Invalid config', 'CONFIG_001');
    ...
    it('should include stack trace', () => {
        const error = new ConfigValidationError('Test error', 'CONFIG_003');
    ...
    it('should handle missing details', () => {
        const error = new ConfigValidationError('Simple error', 'CONFIG_005');
    ...
    it('should preserve error code in stack trace', () => {
        const error = new ConfigValidationError('Error with code', 'CONFIG_006');
