...
describe('Rollup Types Index JavaScript Implementation', () => {
    ...
    describe('IRollupPlugin', () => {
        it('should work with valid plugin object', () => {
            const plugin = {
    ...
    describe('IRollupOutput', () => {
        it('should work with valid output object', () => {
            const output = {
                file: 'dist/bundle.js',
    ...
    describe('IRollupProjectStructure', () => {
        it('should work with valid project structure object', () => {
            const structure = {
