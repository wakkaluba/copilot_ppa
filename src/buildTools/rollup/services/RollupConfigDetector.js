...
var RollupConfigDetector = /** @class */ (function () {
    function RollupConfigDetector(logger) {
        this.configPatterns = [
            'rollup.config.js',
            'rollup.*.config.js',
            '*rollup.config.js',
     ...
     */
    RollupConfigDetector.prototype.detectConfigs = function (workspacePath) {
        return __awaiter(this, void 0, void 0, function () {
            var configs_1, _i, _a, pattern, matches, configArray, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.logger.debug("Searching for rollup configs in ".concat(workspacePath));
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        configs_1 = new Set();
                    ...
                    case 5:
                        ...
                        this.logger.debug("Found ".concat(configArray.length, " rollup config files"));
     ...
     */
    RollupConfigDetector.prototype.findFiles = function (pattern, cwd) {
        var _this = this;
     ...
     */
    RollupConfigDetector.prototype.validateConfigFile = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var fileName_1, isMatch;
            return __generator(this, function (_a) {
                this.logger.debug("Validating rollup config file: ".concat(filePath));
                try {
                    ...
                    if (!isMatch) {
                        this.logger.debug("File ".concat(fileName_1, " does not match rollup config patterns"));
                    ...
                    throw new Error("Failed to validate rollup configuration file: ".concat(error instanceof Error ? error.message : String(error)));
                }
                return [2 /*return*/];
            });
        });
     ...
     */
    RollupConfigDetector.prototype.getDefaultConfigPattern = function (language) {
        var patterns = {
            'js': 'rollup.config.js',
            'ts': 'rollup.config.ts',
