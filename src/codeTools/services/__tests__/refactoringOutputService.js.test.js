// filepath: d:\___coding\tools\copilot_ppa\src\codeTools\services\__tests__\refactoringOutputService.js.test.js
const vscode = require('vscode');
const { RefactoringOutputService } = require('../RefactoringOutputService');
