...
jest.mock('vscode', () => {
    return {
        Uri: {
            with: jest.fn().mockImplementation(function(options) {
                return {
                    ...this,
                    ...options
                };
            ...
            file: jest.fn().mockImplementation((path) => ({
                ...
                path: path,
                scheme: 'file',
                with: jest.fn().mockImplementation((options) => ({
                    fsPath: path,
                    path: path,
                    ...options
                }))
...
describe('CodeDiffService', () => {
    ...
    beforeEach(() => {
        ...
        vscode.Uri.with.mockImplementation(function(options) {
    ...
    describe('showDiff', () => {
        ...
        it('should handle error during document creation', async () => {
            ...
            vscode.workspace.openTextDocument.mockRejectedValueOnce(new Error('Document open error'));
        ...
        it('should handle error during edit application', async () => {
            ...
            vscode.workspace.applyEdit.mockRejectedValueOnce(new Error('Edit application error'));
